...
public class FuckItAllHandler extends ChannelInboundHandlerAdapter
{
    public static final Logger logger = LoggerFactory.getLogger(FuckItAllHandler.class);
    ...
    public FuckItAllHandler(InetAddressAndPort peer, MessageProcessor messageProcessor, boolean handlesLargeMessages)
    {
        this.peer = peer;
